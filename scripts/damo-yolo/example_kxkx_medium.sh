...
# 工作空间准备
name=kxkx_R640__layers${layers}_lat${latency}_ratio${last_ratio}
work_dir=save_model/LightNAS/damo-yolo/${name}

mkdir -p ${work_dir}
space_mutation="space_KXKX"
...
{'class': 'SuperResConvKXKX', 'in': 32, 'out': 48, 's': 2, 'k': 3, 'L': 1, 'btn': 32}, \
{'class': 'SuperResConvKXKX', 'in': 48, 'out': 96, 's': 2, 'k': 3, 'L': 1, 'btn': 48}, \
{'class': 'SuperResConvKXKX', 'in': 96, 'out': 96, 's': 2, 'k': 3, 'L': 1, 'btn': 96}, \
{'class': 'SuperResConvKXKX', 'in': 96, 'out': 192, 's': 1, 'k': 3, 'L': 1, 'btn': 96}, \
{'class': 'SuperResConvKXKX', 'in': 192, 'out': 384, 's': 2, 'k': 3, 'L': 1, 'btn': 192}, \
]" \
