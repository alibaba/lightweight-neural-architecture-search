...
cp scripts/detection/example_R50_FLOPs.sh ${work_dir}
...
mpirun --allow-run-as-root -np 8 -H 127.0.0.1:8 -bind-to none -map-by slot -mca pml ob1 \
  ...
  budget_image_size=480 budget_flops=188e8 budget_latency=None budget_layers=91 budget_model_size=None \
