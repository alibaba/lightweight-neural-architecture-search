...
@SCORES.register_module(module_name = 'stentr')
class ComputeStentrScore(metaclass=ABCMeta):

    def __init__(self, frames = 13, image_size = 160, multi_block_ratio = [0, 0, 1,1,6], ratio = 1, logger=None, **kwargs):
        self.frames = frames
    ...
    def __call__(self, model):
        ...
        kwarg = {'frames': self.frames ,'resolution': self.resolution}
        block_std_list = model.stentr_forward_pre_GAP(**kwarg)
